...
<head>
    ...
    <title>Exemplo pesquisa de Produtos </title>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-group well" action="produtos.php" method="POST">
                        Codigo: <input type="text" name="cod" class="span3" value="" required placeholder="Cod" style=" margin-bottom: -2px; height: 25px;">
                        Nome: <input type="text" name="nome" class="span3" value="" required placeholder="Nome" style=" margin-bottom: -2px; height: 25px;"><br><br>
                        Quantidade: <input type="text" name="quantidade" class="span3" value="" required placeholder="quantidade" style=" margin-bottom: -2px; height: 25px;">
                        Preço: <input type="text" name="preco" class="span3" value="" required placeholder="preço" style=" margin-bottom: -2px; height: 25px;"><br><br>
